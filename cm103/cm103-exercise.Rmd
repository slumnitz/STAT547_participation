...
- coerced to the least-informative data type in the vector. eg. c("hi", 5) -> "hi", "5"
...
- subset with `[`, `[[`, or `$`. 
    * single `[` I want a list with the first component (Python dctionary key)
    * double `[[` I want the contents for the first component, get single component with `$`
...
```{r}
map_chr(wesanderson, function(x)) # %>% unname()
```
